...
2026-09-23 로컬 REAL 통합 시험 준비: [사용 설정·빌드·기동 확인 및 남은 실물 연결](../../docs/validation/2026-09-23-real-integration-ready.md). PR #82의 병합 대상은 main이 아닌 조각 작업 브랜치이므로 시험 소스 기준을 구분한다.
