...
from .workpiece_calibration import MeasurementError, PointMeasurementError, pose, vector, rotation_distance, side_contact_window
...
def ik_sample_indices(start, target, step, workcell, guards):
    ...
    def separated(i):
        ...
        uncertainty=(workcell['max_center_shift_m']+workcell['max_radius_error_m']
        ...
        while True:
            ...
            if probe:
                ...
                if contact_range is not None:
                    ...
                    if travel<contact_range[0] and candidate_force>=profile['contact_force_n']:
                        # baseline 확보 전의 이른 장애물은 재접근하지 않는다.
