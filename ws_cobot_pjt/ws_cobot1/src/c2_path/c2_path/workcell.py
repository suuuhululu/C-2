...
값 출처
  - ws_cobot_pjt/docs/evidence/workcell_candle_0919.yaml (시율님 9/19 실측, PR #32 병합)
...
# --- 원기둥(양초) ----------------------------------------------------------
RADIUS_M = 0.034                      # 자로 잰 지름 68mm. 옆면 터치로는 R+돌출(0.1338)만 확정 — 캘리퍼스 재측정 대기
...
# CUT 이 들어가도 되는 θ 범위. J5 안전 범위 수치를 시율님께 요청 중 — 받기 전까지는 전 범위.
REACHABLE_ANGLE_DEG = (-180.0, 180.0)
