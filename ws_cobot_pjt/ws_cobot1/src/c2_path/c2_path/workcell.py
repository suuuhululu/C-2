...
# 작업 가능 높이 구간 (2026-09-21 시율님 대체 지시): "윗면 아래 10mm·바닥 위 10mm는 조각 금지,
# 그 사이 v=10~140mm(폭 130mm)는 CUT 허용"을 축 원점(바닥) 기준 상대값으로 환산.
# 양초가 통째로 올라가도 윗면 기준 상대 구간은 그대로다.
WORKABLE_HEIGHT_RANGE_M = (HEIGHT_TOTAL_M - 0.140, HEIGHT_TOTAL_M - 0.010)  # (0.010, 0.140)
