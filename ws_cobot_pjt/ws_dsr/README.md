...
2026-09-16 팀원이 수업 절차로 `git clone https://github.com/ahnisinc/cobot_rg2.git src`를 수행했다고 보고했다. 사용자는 MSI Ubuntu에서 Docker 에뮬레이터로 시뮬레이터를 켜고 로봇을 움직였다고 확인했다. 이는 사용자 보고이며, 정확한 설치 커밋·로컬 수정 여부·실제 장비 모델·실기 동작을 확인한 것은 아니다.
