...
> 2026-09-19 적용 범위: 아래는 9/17 확장 설계의 보관 기록이다. 현재는 HMI·고정 드릴·공정 6개 모듈·통신 v2이며 그리퍼 열기/집기/청소/반납을 금지한다. [현재 구조](SYSTEM_STRUCTURE.md), [운영 변경](C2_FIXED_DRILL_20260919.md)을 우선한다.

> 2026-09-18 범위 갱신: 고객용 웹앱을 제외하고 9/18 당시 고정 좌표·교체 도구 개발 기준은 [3개 노드 인터페이스 안내](INTERFACE_GUIDE.md)와 [목표 구조](SYSTEM_STRUCTURE.md)다. 아래는 9/17의 확장 시나리오를 보존한 설계 기록이며 새 계약의 구현 완료를 뜻하지 않는다.
